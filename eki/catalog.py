...
TEMPLATES: List[Dict[str, Any]] = [
    ...
    {"id": "anthropic", "title": "Anthropic API", "kind": "anthropic_api",
     ...
     "capabilities": {"context_tokens": 1000000, "vision": True},
    ...
    {"id": "perplexity", "title": "Perplexity", "kind": "openai_compat",
     "blurb": "Sonar models: every answer is searched on the web first, with sources.",
     "needs": "key", "tier": 100, "note": "metered",
     "capabilities": {"context_tokens": 128000, "web": True},
     "options": {"base_url": "https://api.perplexity.ai", "model": "sonar-pro"}},
    {"id": "deepseek", "title": "DeepSeek API", "kind": "openai_compat",
     "blurb": "DeepSeek's models through their OpenAI-compatible API.",
     "needs": "key", "tier": 100, "note": "metered",
     "capabilities": {"context_tokens": 128000},
     "options": {"base_url": "https://api.deepseek.com/v1", "model": "deepseek-chat"}},
