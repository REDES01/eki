...
Caveat worth keeping in mind: the rules in hub.classify were tuned against
...
hub still ships with the rules on, because they cost nothing and never wait.
...
slow enough to notice — hub's default stays on the rules otherwise.

    python -m hub.evals.label_eval                 # rules only
