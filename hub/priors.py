...
hub has no history on its first day, so it starts from public evidence: on
...
would look like precision hub doesn't have.
...
#: what a request of each difficulty needs before hub will spend a cheap
