...
another window, by `hub watch` in a terminal, or by nobody at all. The
...
async def lifespan(app: FastAPI):
    ...
    async def reap() -> None:
        # unload local models hub started once they've sat unused a while
        while True:
...
def main(argv: Optional[list] = None) -> int:
    import argparse
    ap = argparse.ArgumentParser(prog="hub-service")
